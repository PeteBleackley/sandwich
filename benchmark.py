...
if __name__ == "__main__": 
    ...
    model = Sandwich(
        ...
        definitions_path=babelnet_dir / "definitions.json" if args.definitions is None else args.definitions,
        neighbours_path=babelnet_dir / "neighbours.json" if args.neighbours is None else args.neighbours,
